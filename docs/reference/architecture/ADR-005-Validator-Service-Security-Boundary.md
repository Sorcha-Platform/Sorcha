...
- [Register Service Phase 1-2 Completion](https://github.com/Sorcha-Platform/Sorcha/blob/master/docs/archive/completion-reports/register-service-phase1-2-completion.md)
...
See: [Learnings Document](https://github.com/Sorcha-Platform/Sorcha/blob/master/docs/archive/learnings/2025-11-16-validator-service-refactoring.md)
