...
# The scripted-holder flow (Complete-SorchaWalletPresentation + its base64url / disclosure /
# JOSE helpers) lives in lib/HolderPresentation.ps1 so AIAS M3 can drive the same holder against a
# VERIFIER request without running a rehearsal. Dot-sourced, not duplicated.
