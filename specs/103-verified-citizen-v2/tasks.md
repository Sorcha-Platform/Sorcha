...
- [ ] T004 Reserve a new validator publish-time error code `VAL_BP_010` (or next free in the series) in `src/Services/Sorcha.Validator.Service/Models/ValidationErrorCodes.cs`. Add a constant and an XML doc summary referencing `specs/103-verified-citizen-v2/contracts/validator-publish-errors.md`. No behaviour wiring yet — that lands in T021.
