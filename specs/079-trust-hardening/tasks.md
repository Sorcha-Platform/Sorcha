...
- [ ] T048 [US5] Add `OnTransactionLifecycleUpdate` event to `ActionsHubConnection` in `src/Apps/Sorcha.UI/Sorcha.UI.Core/Services/ActionsHubConnection.cs` — new event with TxId, Status (Pending/Sealed/Receipted), ReceiptId?, DocketNumber?
