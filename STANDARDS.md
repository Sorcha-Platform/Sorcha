...
| ISO 18013-5 (mdoc) | 2021 | ISO/IEC | [ISO 18013-5](https://www.iso.org/standard/69084.html) | `src/Common/Sorcha.Cryptography/Mdoc`, `src/Core/Sorcha.Blueprint.Engine/Credentials/MdocFormatHandler.cs`, `src/Services/Sorcha.Haip.Service/Services/MdocPresentationVerifier.cs` | partial | `mso_mdoc` issuance + OpenID4VP (online) verification, ES256/P-256 only (Feature 135); proximity transport + MAC device-auth deferred |
...
| ERC-191 (`personal_sign`) | ERC-191 | Ethereum | [ERC-191](https://eips.ethereum.org/EIPS/eip-191) | `src/Common/Sorcha.Cryptography.Secp256k1/Eip191.cs`, `src/Common/Sorcha.Cryptography.Secp256k1/Secp256k1Signer.cs` | partial | Recoverable secp256k1 **signing** (RFC-6979 low-s, `r‖s‖v`) + personal-sign digest for prove-control (Feature 180); transacting deferred |
| EIP-4361 (Sign-In With Ethereum) | EIP-4361 | Ethereum | [EIP-4361](https://eips.ethereum.org/EIPS/eip-4361) | `src/Common/Sorcha.Cryptography.Secp256k1/Siwe` | partial | SIWE message format/parse + produce (sign) and verify (Sorcha as relying party) prove-control (Feature 180); wallet-produce endpoints follow-up |
