...
| did:ethr | ERC-1056 | Ethereum / DIF | [did:ethr](https://github.com/decentralized-identity/ethr-did-resolver) | `src/Common/Sorcha.ServiceClients.Http/Did/EthrDidResolver.cs` | partial | Offline **default-document** resolution of address-form DIDs to an `EcdsaSecp256k1RecoveryMethod2020` VM; issuer verify-by-recovery (Feature 178). On-chain registry read (key rotation / delegates) deferred to a later phase |
