...
| ERC-191 (`personal_sign`) | ERC-191 | Ethereum | [ERC-191](https://eips.ethereum.org/EIPS/eip-191) | `src/Common/Sorcha.Cryptography.Secp256k1/Eip191.cs`, `Secp256k1Signer.cs` | partial | Recoverable secp256k1 **signing** (RFC-6979 low-s, `r‖s‖v`) + personal-sign digest for prove-control (Feature 180); transacting deferred |
