...
public interface IRegisterSubscriptionService
{
    ...
    Task<RegisterSubscriptionResponse> SubscribeAsync(Guid orgId, string registerId, string? registerName, Guid subscribedByUserId, CancellationToken ct, string? description = null);
