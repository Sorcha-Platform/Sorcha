...
record BatchReceiptRequest(long DocketNumber, TransactionReceipt[] Receipts);
record VerifyReceiptRequest(TransactionReceipt Receipt, string ValidatorPublicKey);
