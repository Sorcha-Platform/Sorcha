...
/// <c>CredentialGateComponent</c> after submitting the credential-gated
...
/// gate to subscribe to the SignalR group and to address the claims-fetch.
/// </param>
/// <param name="AuthorizationRequestUri">
/// OID4VP <c>openid4vp://…</c> URI the gate renders via HybridQrAffordance.
/// </param>
/// <param name="ClaimsFetchToken">
/// Single-use token bound to <paramref name="PresentationRequestId"/>; the
/// gate presents this on the F127 claims-fetch endpoint after the outcome
